package com.dayton.drone.retrofit.request;
 ...
 */
public abstract class BaseRetroRequest<T,R> extends RetrofitSpiceRequest<T,R> {
    public final String CONTENT_TYPE = "application/json";
    public BaseRetroRequest(Class<T> clazz, Class<R> retrofitedInterfaceClass) {
